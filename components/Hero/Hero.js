...
function Hero() {
  ...
  const four = (
    <div className="heading-description" style={{ textAlign: "left" }}>
      I’m a MERN stack developer specializing in building Web application using
      Modern <span className="skill">Javascript </span> Library and Frameworks
      like
      <span className="skill"> React.js </span>,{" "}
      <span className="skill">Next.js</span> and{" "}
      <span className="skill">Node.js</span>. Currently, I’m focused on
      enhancing my software engineering skill and grinding Leetcode.
    </div>
  );
